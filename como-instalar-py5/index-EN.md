...
[py5](https://github.com/py5coding) is a <u title='Libraries are packages of complementary functions made by other people to help you develop your own programs" style="text-decoration:underline; text-decoration-style: dotted;">library</u> that allows use of the Processing vocabulary and graphical infrastructure with the latest version of the Python programming language.
